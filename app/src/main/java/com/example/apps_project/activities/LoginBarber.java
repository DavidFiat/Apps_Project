...
public class LoginBarber extends AppCompatActivity {
    ...
    private void addBarberInFireBase() {

        FirebaseUser fireUser = FirebaseAuth.getInstance().getCurrentUser();
        User user = new User(fireUser.getUid(),"barber");
        Barber barber = new Barber(""+fireUser.getUid(),""+fireUser.getDisplayName(),0+"",""+fireUser.getEmail(),"","MiehWuLoDeZEhCMZRpsm5lSKb4C2");
